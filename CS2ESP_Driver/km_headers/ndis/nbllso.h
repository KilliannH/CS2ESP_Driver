...
{
    NDIS_TCP_LARGE_SEND_OFFLOAD_NET_BUFFER_LIST_INFO const *Info = (NDIS_TCP_LARGE_SEND_OFFLOAD_NET_BUFFER_LIST_INFO const *)
        &Nbl->NetBufferListInfo[TcpLargeSendNetBufferListInfo];
