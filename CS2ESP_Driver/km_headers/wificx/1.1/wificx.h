...
typedef struct _WIFI_STATION_CAPABILITIES
{
    ...
    DOT11_CIPHER_ALGORITHM * FIPSCertifiedCipherAlgorithmsList; // Array of cipher algorithms for which the device has received FIPS 140 certification, with NumFIPSCertifiedCipherAlgorithms elements
